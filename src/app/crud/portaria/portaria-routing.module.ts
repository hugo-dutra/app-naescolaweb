...
} from './inserir-cronograma-portaria/inserir-cronograma-portaria.component';
...
} from './verificar-frequencia-portaria/verificar-frequencia-portaria.component';
import {
  VerificarAbsenteismoPortariaComponent,
} from './verificar-absenteismo-portaria/verificar-absenteismo-portaria.component';
...
const routes: Routes = [
  ...
  {
    path: 'alterar-portaria', component: AlterarPortariaComponent,
    data: { objeto: 'objeto' }, canActivate: [AuthGuardService],
  },
  {
    path: 'excluir-portaria', component: ExcluirPortariaComponent,
    data: { objeto: 'objeto' }, canActivate: [AuthGuardService],
  },
  ...
  {
    path: 'inserir-cronograma-portaria', component: InserirCronogramaPortariaComponent,
    canActivate: [AuthGuardService],
  },
  {
    path: 'verificar-frequencia-portaria', component: VerificarFrequenciaPortariaComponent,
    canActivate: [AuthGuardService],
  },
  {
    path: 'verificar-absenteismo-portaria', component: VerificarAbsenteismoPortariaComponent,
    canActivate: [AuthGuardService],
  },
