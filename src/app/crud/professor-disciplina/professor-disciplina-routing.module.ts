...
const routes: Routes = [
  {
    path: '', component: InserirProfessorDisciplinaComponent,
    data: { objeto: 'objeto' }, canActivate: [AuthGuardService],
  },
  {
    path: 'listar-professor-disciplina',
    component: ListarProfessorDisciplinaComponent, canActivate: [AuthGuardService],
  },
];
