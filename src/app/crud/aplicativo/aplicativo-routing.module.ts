...
const routes: Routes = [
  ...
  {
    path: 'sincronizar-estudante-aplicativo', component: SincronizarEstudanteAplicativoComponent,
    canActivate: [AuthGuardService],
  },
  {
    path: 'gerar-qrcode-aplicativo-estudante', component: GerarQrcodeAplicativoEstudanteComponent,
    canActivate: [AuthGuardService],
  },
  {
    path: 'gerar-qrcode-aplicativo-administrativo', component: GerarQrcodeAplicativoAdministrativoComponent,
    canActivate: [AuthGuardService],
  },
  {
    path: 'baixar-foto-estudante-aplicativo', component: BaixarFotoEstudanteAplicativoComponent,
    canActivate: [AuthGuardService],
  },
  {
    path: 'gravar-tipo-ocorrencia-aplicativo-administrativo',
    component: GravarTipoOcorrenciaAplicativoAdministrativoComponent,
    canActivate: [AuthGuardService],
  },
  {
    path: 'listar-estudante-sem-foto', component: ListarAplicativoEstudanteSemFotoComponent,
    canActivate: [AuthGuardService],
  },
];
