...
const routes: Routes = [
  ...
  {
    path: 'listar-pedido-cartao-entidade', component: ListarPedidoCartaoEntidadeComponent,
    canActivate: [AuthGuardService],
  },
  {
    path: 'detalhar-pedido-cartao-entidade', component: DetalharPedidoCartaoEntidadeComponent,
    canActivate: [AuthGuardService],
  },
  {
    path: 'registrar-pendencia-pedido-cartao', component: RegistrarPendenciaPedidoCartaoComponent,
    canActivate: [AuthGuardService],
  },
  {
    path: 'listar-pendencia-pedido-cartao', component: ListarPendenciaPedidoCartaoComponent,
    canActivate: [AuthGuardService],
  },
  {
    path: 'listar-pendencia-pedido-cartao-entidade', component: ListarPendenciaPedidoCartaoEntidadeComponent,
    canActivate: [AuthGuardService],
  },
];
