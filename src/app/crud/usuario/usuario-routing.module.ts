...
const routes: Routes = [
  { path: "", component: ListarUsuarioComponent, canActivate: [AuthGuardService] },
  { path: "inserir-usuario", component: InserirUsuarioComponent, canActivate: [AuthGuardService] },
  { path: "excluir-usuario", component: ExcluirUsuarioComponent, data: { objeto: "objeto" }, canActivate: [AuthGuardService] },
